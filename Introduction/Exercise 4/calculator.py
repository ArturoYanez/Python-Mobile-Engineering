...
# For SoloLearn, input all values in the following order, separated by line breaks:
# 1. Operation number (1 for Sum, 2 for Subtraction, 3 for Multiplication, 4 for Division, 5 to Exit)
...
# Example input: 1 5 3 2 10 4 4 12 3 5 (This will perform Sum, Subtraction, Multiplication, then Exit)
